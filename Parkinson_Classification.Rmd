...
Now that we have predicted the diagnoses for the patients, we can combine these predictions with the `PatientID`, sort the patients accordingly, and save the results into a CSV file named **ChowZ.Predictions.csv**.
```{r csv}
save_df <- val_df %>%
